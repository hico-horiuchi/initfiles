...
install:
	mkdir -p $(HOME)/.vim/pack/github/start
	mkdir -p $(HOME)/.config/powerline-shell
	mkdir -p $(HOME)/.local

	rm -fr '$(HOME)/Library/Application Support/Nova/Extensions/screenisland.novacopilotlsp/copilot/dist'
	...
	ln -fs `ghq root`/github.com/github/copilot.vim      $(HOME)/.vim/pack/github/start/copilot.vim
	ln -fs `ghq root`/github.com/github/copilot.vim/dist '$(HOME)/Library/Application Support/Nova/Extensions/screenisland.novacopilotlsp/copilot/dist'
